...
iRect::iRect() {
  ...
  Props.append(
      new Property("I", "1 mA", true, QObject::tr("current at high pulse")));
  Props.append(
      new Property("TH", "1 ms", true, QObject::tr("duration of high pulses")));
  Props.append(
      new Property("TL", "1 ms", true, QObject::tr("duration of low pulses")));
  ...
  Props.append(
      new Property("Td", "0 ns", false, QObject::tr("initial delay time")));
