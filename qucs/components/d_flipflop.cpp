...
D_FlipFlop::D_FlipFlop() {
  ...
  Polylines.append(new qucs::Polyline(
      std::vector<QPointF>{{-20, 6}, {-12, 10}, {-20, 14}},
...
QString D_FlipFlop::vhdlCode(int NumPorts) {
  ...
  s = "  " + Name + " : process (" + Ports.at(0)->Connection->Name + ", " +
...
QString D_FlipFlop::spice_netlist(
  ...
  s += " " + tmp_model + "\n";
  s += QStringLiteral(".model %1 d_dff(clk_delay=%2 set_delay=%2 "
