...
BJT_SPICE::BJT_SPICE() {
  Description =
      QObject::tr("Q(NPN) BJT:\nMultiple line ngspice or Xyce Q model "
                  "specifications allowed using \"+\" continuation "
  ...
  Props.append(
      new Property("Model", "", true, "Param list and\n .model spec."));
  Props.append(
      new Property("Model_Line 2", "", false, "+ continuation line 1"));
  Props.append(
      new Property("Model_Line 3", "", false, "+ continuation line 2"));
  Props.append(
      new Property("Model_Line 4", "", false, "+ continuation line 3"));
  Props.append(
      new Property("Model_Line 5", "", false, "+ continuation line 4"));
...
QString BJT_SPICE::spice_netlist(
