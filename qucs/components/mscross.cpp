...
MScross::MScross() {
  ...
  Props.append(
      new Property("W3", "1 mm", true, QObject::tr("width of line 3")));
  Props.append(
      new Property("W4", "2 mm", true, QObject::tr("width of line 4")));
...
void MScross::createSymbol() {
  ...
  Lines.append(new qucs::Line(0, -30, 0, -18, QPen(Qt::darkBlue, 2)));
