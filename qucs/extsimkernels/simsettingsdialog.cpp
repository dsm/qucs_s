...
SimSettingsDialog::SimSettingsDialog(QWidget* parent)
    : QDialog(parent), a_lblXyce(new QLabel(tr("Xyce executable location"))),
      ...
      a_edtNgspiceSimParam(new QLineEdit()), a_edtXyceSimParam(new QLineEdit()),
...
void SimSettingsDialog::slotSetNgspice() {
  QString s = QFileDialog::getOpenFileName(
      this, tr("Select Ngspice executable location"), a_edtNgspice->text(),
      "All files (*)");
  if (!s.isEmpty()) {
...
void SimSettingsDialog::slotSetXyce() {
  QString s =
      QFileDialog::getOpenFileName(this, tr("Select Xyce executable location"),
                                   a_edtXyce->text(), "All files (*)");
  if (!s.isEmpty()) {
    a_edtXyce->setText(s);
  }
}
...
void SimSettingsDialog::slotSetSpiceOpus() {
  QString s = QFileDialog::getOpenFileName(
      this, tr("Select SpiceOpus executable location"), a_edtSpiceOpus->text(),
      "All files (*)");
  if (!s.isEmpty()) {
...
void SimSettingsDialog::slotSetQucsator() {
  QString s = QFileDialog::getOpenFileName(
      this, tr("Select Qucsator executable location"), a_edtQucsator->text(),
      "All files (*)");
  if (!s.isEmpty()) {
