...
gNL::gNL() {
  Description = QObject::tr(
      "SPICE G (VOL, VALUE, TABLE, POLY):\nMultiple line ngspice non-linear G "
      "specifications allowed using \"+\" continuation lines.\nLeave "
      "continuation lines blank when NOT in use.");
  ...
  Props.append(
      new Property("G", "", true, "Non-linear spec.\n(with control nodes)"));
