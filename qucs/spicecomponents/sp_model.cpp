...
S4Q_Model::S4Q_Model() {
  ...
  Description = QObject::tr(".MODEL section\n"
                            "Multiple line ngspice or Xyce .MODEL allowed "
  ...
  Props.append(new Property("Line_1", ".MODEL DIODE1 D(BV=50 Is=1e-13 N = 1.5)",
                            true, "Model statement"));
  ...
  Props.append(
      new Property("Line_5", "", false,
                   "")); // empty description to allow extendeable .MODEL
}
