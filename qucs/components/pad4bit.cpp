...
pad4bit::pad4bit() {
  ...
  Props.append(
      new Property("Number", "0", false, QObject::tr("pad output value")));
...
QString pad4bit::verilogCode(int) {
  ...
  l2 = "  begin\n"
       "    case (" +
       v + ")\n" + "       0 : begin " + AR + " = 0; " + BR + " = 0; " + CR +
       " = 0; " + DR + " = 0; end\n" + "       1 : begin " + AR + " = 0; " +
       BR + " = 0; " + CR + " = 0; " + DR + " = 1; end\n" +
       "       2 : begin " + AR + " = 0; " + BR + " = 0; " + CR + " = 1; " +
       DR + " = 0; end\n" + "       3 : begin " + AR + " = 0; " + BR +
       " = 0; " + CR + " = 1; " + DR + " = 1; end\n" + "       4 : begin " +
       AR + " = 0; " + BR + " = 1; " + CR + " = 0; " + DR + " = 0; end\n" +
       "       5 : begin " + AR + " = 0; " + BR + " = 1; " + CR + " = 0; " +
       DR + " = 1; end\n" + "       6 : begin " + AR + " = 0; " + BR +
       " = 1; " + CR + " = 1; " + DR + " = 0; end\n" + "       7 : begin " +
       AR + " = 0; " + BR + " = 1; " + CR + " = 1; " + DR + " = 1; end\n" +
       "       8 : begin " + AR + " = 1; " + BR + " = 0; " + CR + " = 0; " +
       DR + " = 0; end\n" + "       9 : begin " + AR + " = 1; " + BR +
       " = 0; " + CR + " = 0; " + DR + " = 1; end\n" + "      10 : begin " +
       AR + " = 1; " + BR + " = 0; " + CR + " = 1; " + DR + " = 0; end\n" +
       "      11 : begin " + AR + " = 1; " + BR + " = 0; " + CR + " = 1; " +
       DR + " = 1; end\n" + "      12 : begin " + AR + " = 1; " + BR +
       " = 1; " + CR + " = 0; " + DR + " = 0; end\n" + "      13 : begin " +
       AR + " = 1; " + BR + " = 1; " + CR + " = 0; " + DR + " = 1; end\n" +
       "      14 : begin " + AR + " = 1; " + BR + " = 1; " + CR + " = 1; " +
       DR + " = 0; end\n" + "      15 : begin " + AR + " = 1; " + BR +
       " = 1; " + CR + " = 1; " + DR + " = 1; end\n" + "    endcase\n";
  l3 = "  end\n";
  l  = l1 + l2 + l3;
