...
iPWL::iPWL() {
  Description =
      QObject::tr("SPICE I(PWL):\nMultiple line ngspice or Xyce I "
  ...
  Lines.append(new qucs::Line(
      -7, 0, 6, 0, QPen(Qt::darkRed, 3, Qt::SolidLine, Qt::FlatCap)));
  ...
  Props.append(
      new Property("PWL", "", true, "Piece-Wise Linear\nSpecification"));
