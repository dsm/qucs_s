...
Ampere_noise::Ampere_noise() {
  ...
  Lines.append(new qucs::Line(
      -8.5, 0, 6, 0, QPen(Qt::darkBlue, 3, Qt::SolidLine, Qt::FlatCap)));
  ...
  // diagonal strokes
  Lines.append(new qucs::Line(
      -12, 1, 1, -12, QPen(Qt::darkBlue, 2, Qt::SolidLine, Qt::FlatCap)));
  Lines.append(new qucs::Line(
      -10, 6, -7, 3, QPen(Qt::darkBlue, 2, Qt::SolidLine, Qt::FlatCap)));
  Lines.append(new qucs::Line(
      3, -7, 6, -10, QPen(Qt::darkBlue, 2, Qt::SolidLine, Qt::FlatCap)));
  Lines.append(new qucs::Line(
      -7, 10, -2, 5, QPen(Qt::darkBlue, 2, Qt::SolidLine, Qt::FlatCap)));
  Lines.append(new qucs::Line(
      7, -4, 10, -7, QPen(Qt::darkBlue, 2, Qt::SolidLine, Qt::FlatCap)));
  Lines.append(new qucs::Line(
      -1, 12, 12, -1, QPen(Qt::darkBlue, 2, Qt::SolidLine, Qt::FlatCap)));
