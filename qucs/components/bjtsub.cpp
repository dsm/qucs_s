...
Basic_BJT::Basic_BJT() {
  ...
  Props.append(
      new Property("Is", "1e-16", true, QObject::tr("saturation current")));
  ...
  Props.append(new Property(
      "Ikf", "0", false, QObject::tr("high current corner for forward beta")));
  Props.append(new Property(
      "Ikr", "0", false, QObject::tr("high current corner for reverse beta")));
  Props.append(
      new Property("Vaf", "0", true, QObject::tr("forward early voltage")));
  Props.append(
      new Property("Var", "0", false, QObject::tr("reverse early voltage")));
  Props.append(
      new Property("Ise", "0", false,
                   QObject::tr("base-emitter leakage saturation current")));
  Props.append(
      new Property("Ne", "1.5", false,
                   QObject::tr("base-emitter leakage emission coefficient")));
  Props.append(
      new Property("Isc", "0", false,
                   QObject::tr("base-collector leakage saturation current")));
  Props.append(
      new Property("Nc", "2", false,
                   QObject::tr("base-collector leakage emission coefficient")));
  Props.append(new Property("Bf", "100", true, QObject::tr("forward beta")));
  Props.append(new Property("Br", "1", false, QObject::tr("reverse beta")));
  Props.append(
      new Property("Rbm", "0", false,
                   QObject::tr("minimum base resistance for high currents")));
  Props.append(new Property(
      "Irb", "0", false, QObject::tr("current for base resistance midpoint")));
  Props.append(new Property("Rc", "0", false,
                            QObject::tr("collector ohmic resistance")));
  Props.append(
      new Property("Re", "0", false, QObject::tr("emitter ohmic resistance")));
  Props.append(new Property(
      "Rb", "0", false,
      QObject::tr(
  ...
  Props.append(
      new Property("Cjs", "0", false,
                   QObject::tr("zero-bias collector-substrate capacitance")));
  Props.append(
      new Property("Vjs", "0.75", false,
                   QObject::tr("substrate junction built-in potential")));
  Props.append(new Property(
      "Mjs", "0", false, QObject::tr("substrate junction exponential factor")));
  Props.append(new Property(
      "Fc", "0.5", false,
  ...
  Props.append(
      new Property("Af", "1.0", false, QObject::tr("flicker noise exponent")));
  Props.append(new Property("Ffe", "1.0", false,
                            QObject::tr("flicker noise frequency exponent")));
  Props.append(
      new Property("Kb", "0.0", false, QObject::tr("burst noise coefficient")));
  Props.append(
      new Property("Ab", "1.0", false, QObject::tr("burst noise exponent")));
  Props.append(
      new Property("Fb", "1.0", false,
...
QString BJTsub::spice_netlist(
  ...
  spice_incompat << "Type" << "Area" << "Temp" << "Ffe" << "Kb" << "Ab" << "Fb"
                 << "UseGlobTemp"; // spice-incompatible parameters
  ...
  if (getProperty("UseGlobTemp")->Value == "yes" || isDialectCDL) {
    s += QStringLiteral(" QMOD_%1 %2=%3\n")
             .arg(Name)
             .arg(isDialectCDL ? "$EA" : "AREA")
             .arg(getProperty("Area")->Value);
  } else {
