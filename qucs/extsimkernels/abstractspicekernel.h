...
private:
  ...
  void normalizeVarsNames(QStringList& var_list, const QString& dataset_prefix,
                          bool isCustom = false);
  ...
  bool extractASCIISamples(QString& lin, QTextStream& ngsp_data,
                           QList<QList<double>>& sim_points, int NumVars,
                           bool isComplex);
...
protected:
  ...
  bool a_parseFourTHD; // Fourier output is parsed twice, first freqencies, then
                       // THD
  ...
  virtual void
  startNetlist(QTextStream& stream,
               spicecompat::SpiceDialect dialect = spicecompat::SPICEDefault);
  virtual void createNetlist(QTextStream& stream, int NumPorts,
                             QStringList& simulations, QStringList& vars,
                             QStringList& outputs);
...
public:
  ...
  void parseFourierOutput(QString ngspice_file,
                          QList<QList<double>>& sim_points,
  ...
  void parseSTEPOutput(QString ngspice_file, QList<QList<double>>& sim_points,
                       QStringList& var_list, bool& isComplex,
  ...
  void parsePrnOutput(const QString& ngspice_file,
                      ...
                      bool isComplex);
  void parseXYCESTDOutput(QString std_file, QList<QList<double>>& sim_points,
                          QStringList& var_list, bool& isComplex,
                          bool& hasParSweep);
