...
log_amp::log_amp() {
  ...
  Props.append(new Property("Kv", "1.0", false, QObject::tr("scale factor")));
  ...
  Props.append(new Property("Ibr", "5e-12", false,
                            QObject::tr("input reference bias current") + " (" +
                                QObject::tr("A") + ")"));
  Props.append(new Property("M", "5", false, QObject::tr("number of decades")));
...
void log_amp::createSymbol() {
  ...
  Lines.append(new qucs::Line(-5, -10, -5, 10, QPen(Qt::red, 2)));
  Lines.append(new qucs::Line(-5, 10, 5, 10, QPen(Qt::red, 2)));
