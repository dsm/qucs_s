...
public:
  QDoubleSpinBox_Comma_Dot_Decimal_Separator(QWidget* parent = nullptr)
...
private:
  ...
  QComboBox *ComboR1_PowerUnits, *ComboR2_PowerUnits, *ComboR3_PowerUnits,
      *ComboR4_PowerUnits, *Combo_InputPowerUnits;
  QLabel *PdissLabel, *Label_Pin;
  QLineEdit *lineEdit_R1, *lineEdit_R2, *lineEdit_R3, *lineEdit_R4,
      *lineEdit_Results;
  QLineEdit *lineEdit_R1_Pdiss, *lineEdit_R2_Pdiss, *lineEdit_R3_Pdiss,
      *lineEdit_R4_Pdiss;
  QDoubleSpinBox_Comma_Dot_Decimal_Separator *QSpinBox_InputPower,
      *QSpinBox_Attvalue, *QSpinBox_Zin, *QSpinBox_Zout;
