...
Source_ac::Source_ac() {
  ...
  Arcs.append(
      new qucs::Arc(-19, -9, 18, 18, 0, 16 * 360, QPen(Qt::darkBlue, 2)));
  Arcs.append(
      new qucs::Arc(-13, -6, 6, 6, 16 * 270, 16 * 180, QPen(Qt::darkBlue, 2)));
  Arcs.append(
      new qucs::Arc(-13, 0, 6, 6, 16 * 90, 16 * 180, QPen(Qt::darkBlue, 2)));
...
QString Source_ac::spice_netlist(
