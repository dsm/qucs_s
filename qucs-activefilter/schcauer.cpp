...
SchCauer::SchCauer(Filter::FilterFunc ffunc_, Filter::FType type_,
                   FilterParam par)
...
void SchCauer::calcBandStop() {
  ...
  for (int k = 1; k <= order / 2; k++) {
    ...
    double E1 =
        (1.0 / B) * sqrt(0.5 * C * (H + sqrt(H * H - 4.0 * B * B * Q * Q)));
    double G  = (B * E1) / (Q * C);
...
void SchCauer::createGenericSchematic(QString& s) {
  ...
  s += "<.DC DC1 1 40 510 0 61 0 0 \"26.85\" 0 \"0.001\" 0 \"1 pA\" 0 \"1 uV\" "
       "0 \"no\" 0 \"150\" 0 \"no\" 0 \"none\" 0 \"CroutLU\" 0>\n";
  s += "<Eqn Eqn1 1 640 520 -30 14 0 0 \"K=dB(out.v/in.v)\" 1 \"yes\" 0>\n";
  s += QStringLiteral("<.AC AC1 1 320 510 0 61 0 0 \"lin\" 1 \"1 Hz\" 1 \"%1 "
                      "kHz\" 1 \"1001\" 1 \"no\" 0>\n")
           .arg(Fac);
  ...
  for (int i = 1; i <= N2ord; i++) {
    ...
    s += QStringLiteral(
             "<OpAmp OP%1 1 %2 240 -26 -70 1 0 \"1e6\" 1 \"15 V\" 0>\n")
             .arg(1 + (i - 1) * Nop1)
             .arg(270 + dx);
    s += QStringLiteral(
             "<OpAmp OP%1 1 %2 400 -26 -70 1 0 \"1e6\" 1 \"15 V\" 0>\n")
             .arg(2 + (i - 1) * Nop1)
             .arg(300 + dx);
    s += QStringLiteral(
             "<OpAmp OP%1 1 %2 260 -26 42 0 0 \"1e6\" 1 \"15 V\" 0>\n")
             .arg(3 + (i - 1) * Nop1)
             .arg(560 + dx);
    s += QStringLiteral(
             "<C C%1 1 %2 150 -26 17 0 0 \"%3%4\" 1 \"\" 0 \"neutral\" 0>\n")
             .arg(1 + (i - 1) * Nc1)
             .arg(330 + dx)
             .arg(C1, 0, 'f', 3)
             .arg(suffix1);
    s += QStringLiteral(
             "<C C%1 1 %2 400 -26 17 0 0 \"%3%4\" 1 \"\" 0 \"neutral\" 0>\n")
             .arg(2 + (i - 1) * Nc1)
             .arg(450 + dx)
             .arg(C2, 0, 'f', 3)
             .arg(suffix2);
    s += QStringLiteral("<R R%1 1 %2 220 -26 15 0 0 \"%3k\" 1 \"26.85\" 0 "
                        "\"0.0\" 0 \"0.0\" 0 \"26.85\" 0 \"european\" 0>\n")
             .arg(1 + (i - 1) * Nr1)
             .arg(180 + dx)
             .arg(stage.R1, 0, 'f', 3);
    s += QStringLiteral("<R R%1 1 %2 240 -26 15 0 0 \"%3k\" 1 \"26.85\" 0 "
                        "\"0.0\" 0 \"0.0\" 0 \"26.85\" 0 \"european\" 0>\n")
             .arg(2 + (i - 1) * Nr1)
             .arg(410 + dx)
             .arg(stage.R2, 0, 'f', 3);
    s += QStringLiteral("<R R%1 1 %2 110 -26 15 0 0 \"%3k\" 1 \"26.85\" 0 "
                        "\"0.0\" 0 \"0.0\" 0 \"26.85\" 0 \"european\" 0>\n")
             .arg(3 + (i - 1) * Nr1)
             .arg(440 + dx)
             .arg(stage.R3, 0, 'f', 3);
    s += QStringLiteral("<R R%1 1 %2 320 -26 15 0 0 \"%3k\" 1 \"26.85\" 0 "
                        "\"0.0\" 0 \"0.0\" 0 \"26.85\" 0 \"european\" 0>\n")
             .arg(4 + (i - 1) * Nr1)
             .arg(360 + dx)
             .arg(stage.R4, 0, 'f', 3);
    s += QStringLiteral("<R R%1 1 %2 380 -26 15 0 0 \"%3k\" 1 \"26.85\" 0 "
                        "\"0.0\" 0 \"0.0\" 0 \"26.85\" 0 \"european\" 0>\n")
             .arg(5 + (i - 1) * Nr1)
             .arg(190 + dx)
             .arg(stage.R5, 0, 'f', 3);
    ...
    if ((ftype == Filter::BandPass) || (ftype == Filter::BandStop)) {
      ...
      s += QStringLiteral("<R R%1 1 %2 370 -26 15 0 0 \"%3k\" 1 \"26.85\" 0 "
                          "\"0.0\" 0 \"0.0\" 0 \"26.85\" 0 \"european\" 0>\n")
               .arg(6 + (i - 1) * Nr1)
               .arg(570 + dx)
               .arg(stage.R6, 0, 'f', 3);
      s += QStringLiteral("<R R%1 1 %2 440 15 -26 0 1 \"%3k\" 1 \"26.85\" 0 "
                          "\"0.0\" 0 \"0.0\" 0 \"26.85\" 0 \"european\" 0>\n")
               .arg(7 + (i + 1) * Nr1)
               .arg(500 + dx)
               .arg(stage.R6, 0, 'f', 3);
