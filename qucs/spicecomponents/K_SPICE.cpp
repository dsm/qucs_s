...
K_SPICE::K_SPICE() {
  Description = QObject::tr("SPICE K:\nEnter the names of the coupled "
                            "inductances and their coupling factor.");
  ...
  Props.append(new Property("K", "0.1", true,
                            QObject::tr("Coupling factor ( 0  <  K  <= 1)")));
