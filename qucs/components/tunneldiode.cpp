...
TunnelDiode::TunnelDiode() {
  ...
  Props.append(new Property("Ip", "4 mA", true, QObject::tr("peak current")));
  Props.append(
      new Property("Iv", "0.6 mA", true, QObject::tr("valley current")));
  Props.append(
      new Property("Vv", "0.8 V", true, QObject::tr("valley voltage")));
  Props.append(new Property("Wr", "2.7e-20", false,
                            QObject::tr("resonance energy in Ws")));
  Props.append(
      new Property("eta", "1e-20", false, QObject::tr("Fermi energy in Ws")));
  ...
  Props.append(new Property(
      "de", "0.9", false, QObject::tr("fitting factor for electron density")));
  ...
  Props.append(
      new Property("Vj", "0.5 V", false, QObject::tr("junction potential")));
