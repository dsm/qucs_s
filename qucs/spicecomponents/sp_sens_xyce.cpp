...
SpiceSENS_Xyce::SpiceSENS_Xyce() {
  ...
  Props.append(
      new Property("Param", "V1", true, QObject::tr("Parameter for DC sweep")));
  Props.append(new Property("Start", "5", true,
                            QObject::tr("start value for DC sweep")));
  Props.append(
      new Property("Stop", "50", true, QObject::tr("stop value for DC sweep")));
...
Element* SpiceSENS_Xyce::info(QString& Name, char*& BitmapFile,
                              bool getNewOne) {
...
QString SpiceSENS_Xyce::spice_netlist(
