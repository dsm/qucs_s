...
public:
  ...
  virtual void calcCoordinate(const double*, const double*, const double*,
                              float*, float*, Axis const*) const {};
  void calcCoordinateP(const double* x, const double* y, const double* z,
...
protected:
  ...
  QTransform pointTransform; // Transform between Qucs-S logical coordinates and
                             // diagram (logical) point coordinates.
  QTransform valueTransform; // Transform between diagram point coordinates and
                             // diagram values.
