...
QString comp_4bit::vhdlCode(int) {
  ...
  s = "\n  " + Name + ":process (" + X0 + ", " + X1 + ", " + X2 + ", " + X3 +
      ", " + Y0 + ", " + Y1 + ", " + Y2 + ", " + Y3 + ")\n" +
      "  variable P0, P1, P2, P3, P4, P5, P6, P7, P8, P9, P10, P11 : "
      "std_logic;\n" +
      "  begin\n" + "    P0  := not (" + X0 + " xor " + Y0 + ");\n" +
      "    P1  := not (" + X1 + " xor " + Y1 + ");\n" + "    P2  := not (" +
      X2 + " xor " + Y2 + ");\n" + "    P3  := not (" + X3 + " xor " + Y3 +
      ...
      " and (not " + Y2 + ");\n" + "    P11 := " + X3 + " and (not " + Y3 +
      ");\n" + "    " + L +
      " <= P7 or (P3 and P6) or (P3 and P2 and P5) or (P3 and P2 and P1 and "
      "P4)" +
      td + "    " + G +
      " <= P11 or (P3 and P10) or (P3 and P2 and P9) or (P3 and P2 and P1 and "
      "P8)" +
      td + "    " + E + " <= P3 and P2 and P1 and P0" + td + "  end process;\n";
  return s;
}
...
QString comp_4bit::verilogCode(int) {
  ...
  l = "\n  // " + Name + " 4bit comparator\n" + "  assign  " + L + " = " + LR +
      ...
      "  always @ (" + X0 + " or " + X1 + " or " + X2 + " or " + X3 + " or " +
      Y0 + " or " + Y1 + " or " + Y2 + " or " + Y3 + ")\n" + "  begin\n" +
      "    P0  = ~(" + X0 + " ^ " + Y0 + ");\n" + "    P1  = ~(" + X1 + " ^ " +
      Y1 + ");\n" + "    P2  = ~(" + X2 + " ^ " + Y2 + ");\n" + "    P3  = ~(" +
      X3 + " ^ " + Y3 + ");\n" + "    P4  = (~" + X0 + ") && " + Y0 + ";\n" +
      "    P5  = (~" + X1 + ") && " + Y1 + ";\n" + "    P6  = (~" + X2 +
