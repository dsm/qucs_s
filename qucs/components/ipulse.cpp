/***************************************************************************
    ...
    copyright          : (C) 2015 by Vadim Kusnetsov (Vadim Kuznetsov
 (ra3xdh@gmail.com) and Mike Brinson (mbrin72043@yahoo.co.uk
 **************************************************************************/
...
iPulse::iPulse() {
  ...
  Lines.append(new qucs::Line(
      -8, 0, 6, 0, QPen(Qt::darkBlue, 3, Qt::SolidLine, Qt::FlatCap)));
  ...
  Props.append(
      new Property("I2", "1 A", true, QObject::tr("current of the pulse")));
  Props.append(
      new Property("T1", "0", true, QObject::tr("start time of the pulse")));
...
QString iPulse::spice_netlist(
  ...
  s +=
      QStringLiteral(" DC 0 PULSE(%1 %2 %3 %4 %5 {(%6)-(%3)-(%4)-(%5)}) AC 0\n")
          .arg(IL)
          .arg(IH)
          .arg(T1)
          .arg(Tr)
