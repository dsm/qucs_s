...
private:
  ...
  // Maps to contain specialisations for different sweep types. Note: the
  // arrangement has been chosen to have the smallest number of map elements.
  // TODO: Make these constant once settled, see
  ...
  // TODO: It would be better for simulations with sweeps to have a flag saying
  // so.
  bool isEquation;
  bool hasSweep;
  bool hasFile = false;
  ...
  void updateEqnSimulation(const QString& propertyWidget,
                           const QString& value) {
    (void)propertyWidget;
    (void)value;
  };
