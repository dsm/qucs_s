...
AboutDialog::AboutDialog(QWidget* parent) : QDialog(parent) {
  qucs_sDevs = {
      {"Vadim Kuznetsov - " +
           tr("project maintainer, simulator interface and GUI design"),
  ...
  currAuths = {
      {"Guilherme Brondani Torri - " +
           tr("GUI programmer, Verilog-A dynamic loader"),
       "Mike Brinson - " +
           tr("testing, modelling and documentation, tutorial contributor"),
       "Richard Crozier - " + tr("testing, modelling, Octave."),
       "Bastien Roucaries - " +
           tr("bondwire and rectangular waveguide model implementation"),
       "Frans Schreuder - " + tr("GUI programmer, release"),
       "Vadim Kuznetsov - " + tr("filter synthesis (qucs-activefilter), SPICE "
                                 "integration (NGSPICE, Xyce)"),
  ...
  prevDevs = {
      {"Michael Margraf - " + tr("founder of the project, GUI programmer"),
       ...
       "Raimund Jacob - " + tr("tester and applyer of Stefan's patches, author "
                               "of documentation"),
       "Vincent Habchi - " + tr("coplanar line and filter synthesis code, "
                                "documentation contributor"),
       "Toyoyuki Ishikawa - " +
           tr("some filter synthesis code and attenuator synthesis"),
       "Gopala Krishna A - " + tr("GUI programmer, Qt4 porter"),
       "Helene Parruitte - " + tr("programmer of the Verilog-AMS interface"),
       "Gunther Kraut - " + tr("equation solver contributions, exponential "
  ...
  trAuths = {{tr("German by") + " Stefan Jahn",
              ...
              tr("Kazakh by") + " Erbol Keshubaev", tr("Chinese by") + " HGC"}};
  ...
  vl->addWidget(
      new QLabel("<span style='font-size:x-large; font-weight:bold;'>Quite "
                 "Universal Circuit Simulator</span>"));
  ...
  supportText =
      tr("Home Page") +
      " : <a "
      "href='https://ra3xdh.github.io/'>https://ra3xdh.github.io/</a><br/>" +
      tr("Documentation start page") +
      " : <a "
      "href='https://qucs-s-help.readthedocs.io/'>https://"
      "qucs-s-help.readthedocs.io/</a><br/>" +
      tr("Bugtracker page") +
      " : <a "
      "href='https://github.com/ra3xdh/qucs_s/issues'>https://github.com/"
      "ra3xdh/qucs_s/issues</a><br/>" +
      tr("Forum") +
      " : <a "
      "href='https://github.com/ra3xdh/qucs_s/discussions'>https://github.com/"
      "ra3xdh/qucs_s/discussions</a><br/>";
  ...
  QString licenseText;
  licenseText =
      "Qucs-S is free software; you can redistribute it and/or modify it under "
      "the terms of the GNU General Public License as published by the Free "
      "Software Foundation; either version 2, or (at your option) any later "
      "version.<br/><br/>This software is distributed in the hope that it will "
      "be useful,but WITHOUT ANY WARRANTY; without even the implied warranty "
      "of MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the GNU "
      "General Public License for more details..<br/><br/> You should have "
      "received a copy of the GNU General Public License along with Qucs, see "
      "the file COPYING. If not see <a "
      "href='http://www.gnu.org/licenses/'>http://www.gnu.org/licenses/</a> or "
