...
public:
  ...
  virtual bool getSelected(const QPoint& /*click*/, int /*tolerance*/) {
    return false;
  };
  virtual bool resizeTouched(const QPoint& /*click*/, int /*tolerance*/) {
    return false;
  };

  virtual void MouseMoving(const QPoint& /*onGrid*/, Schematic* /*sch*/,
                           const QPoint& /*cursor*/) {};
  virtual bool MousePressing(Schematic* sch = nullptr) {
    Q_UNUSED(sch)
    return false;
  };
  ...
  virtual bool Dialog(QWidget* parent = nullptr) {
    Q_UNUSED(parent)
    return false;
  };
...
protected:
  ...
  virtual void afterMove([[maybe_unused]] int dx,
                         [[maybe_unused]] int dy) noexcept {};
};
