...
Ampere_ac::Ampere_ac() {
  ...
  Arcs.append(
      new qucs::Arc(-12, -12, 24, 24, 0, 16 * 360, QPen(Qt::darkBlue, 2)));
  ...
  // AC-wave
  Arcs.append(new qucs::Arc(12, 5, 6, 6, 16 * 270, 16 * 180,
                            QPen(Qt::darkBlue, 2, Qt::SolidLine, Qt::FlatCap)));
  Arcs.append(new qucs::Arc(12, 11, 6, 6, 16 * 90, 16 * 180,
                            QPen(Qt::darkBlue, 2, Qt::SolidLine, Qt::FlatCap)));
  ...
  Props.append(
      new Property("I", "1 mA", true, QObject::tr("peak current in Ampere")));
  Props.append(
      new Property("f", "1 kHz", false, QObject::tr("frequency in Hertz")));
  Props.append(new Property("Phase", "0", false,
                            QObject::tr("initial phase in degrees")));
  Props.append(
      new Property("Theta", "0", false,
  ...
  Props.append(
      new Property("TD", "0", false, QObject::tr("delay time (SPICE only)")));
...
QString Ampere_ac::spice_netlist(
