...
#define TRANS_END                                                              \
  { NULL, 0, NULL, {NULL}, 0, TRANS_QOBJS }
#define TRANS_RESULT                                                           \
  { NULL, NULL, NULL }
#define TRANS_RESULTS                                                          \
  { TRANS_RESULT }
...
struct TransType TransLineTypes[] = {
    {ModeMicrostrip,
     ...
     {{{{"Er", 2.94, NULL, TRANS_NONES, 0, TRANS_QOBJS},
        ...
        TRANS_END}},
      {{{"Freq", 1, NULL, TRANS_FREQS, 0, TRANS_QOBJS}, TRANS_END}},
    ...
    {ModeRectangular,
     ...
     {{{{"Er", 1, NULL, TRANS_NONES, 0, TRANS_QOBJS},
        ...
        TRANS_END}},
      {{{"Freq", 10, NULL, TRANS_FREQS, 0, TRANS_QOBJS}, TRANS_END}},
...
void QucsTranscalc::createResultItem(QGridLayout* parentGrid,
                                     TransResult* res) {
...
bool QucsTranscalc::saveFile(QString fname) {
  ...
  stream << "#   Generated on " << QDate::currentDate().toString() << " at "
...
void QucsTranscalc::slotCopyToClipBoard() {
  ...
  if (mode == ModeMicrostrip) {
    ...
    s += "<Components>\n";
    s += "  <Pac P1 1 90 150 -74 -26 1 1 \"1\" 1 \"50 Ohm\" 1 \"0 dBm\" 0 \"1 "
         "GHz\" 0 \"26.85\" 0>\n";
    s += "  <Pac P2 1 270 150 18 -26 0 1 \"2\" 1 \"50 Ohm\" 1 \"0 dBm\" 0 \"1 "
         "GHz\" 0 \"26.85\" 0>\n";
    s += "  <GND * 1 90 180 0 0 0 0>\n";
    s += "  <GND * 1 270 180 0 0 0 0>\n";
    s += QStringLiteral("  <SUBST SubstTC1 1 390 140 -30 24 0 0 \"%1\" 1 \"%2 "
                        "mm\" 1 \"%3 um\" 1 \"%4\" 1 \"%5\" 1 \"%6\" 1>\n")
    ...
    s += "\"51\" 1 \"no\" 0 \"1\" 0 \"2\" 0>\n";
    s += QStringLiteral(
             "  <MLIN MSTC1 1 180 100 -26 15 0 0 \"SubstTC1\" 1 \"%1 mm\" 1 "
             "\"%2 mm\" 1 \"Hammerstad\" 0 \"Kirschning\" 0 \"26.85\" 0>\n")
             .arg(l->getProperty("W", UNIT_LENGTH, LENGTH_MM))
             .arg(l->getProperty("L", UNIT_LENGTH, LENGTH_MM));
    s += "  <Eqn EqnTC1 1 240 260 -23 12 0 0 \"A=twoport(S,'S','A')\" 1 "
         "\"ZL=real(sqrt(A[1,2]/A[2,1]))\" 1 \"yes\" 0>\n";
    s += "</Components>\n";
    s += "<Wires>\n";
  ...
  // create coupled microstrip schematic
    ...
    s += "<Components>\n";
    s += "  <Pac P1 1 100 130 -74 -26 1 1 \"1\" 1 \"50 Ohm\" 1 \"0 dBm\" 0 \"1 "
         "GHz\" 0 \"26.85\" 0>\n";
    s += "  <Pac P2 1 320 130 18 -26 0 1 \"2\" 1 \"50 Ohm\" 1 \"0 dBm\" 0 \"1 "
         "GHz\" 0 \"26.85\" 0>\n";
    s += "  <Pac P3 1 280 220 18 -26 0 1 \"3\" 1 \"50 Ohm\" 1 \"0 dBm\" 0 \"1 "
         "GHz\" 0 \"26.85\" 0>\n";
    s += "  <Pac P4 1 140 200 -74 -26 1 1 \"4\" 1 \"50 Ohm\" 1 \"0 dBm\" 0 \"1 "
         "GHz\" 0 \"26.85\" 0>\n";
    s += "  <GND * 1 100 160 0 0 0 0>\n";
    s += "  <GND * 1 140 230 0 0 0 0>\n";
    s += "  <GND * 1 320 160 0 0 0 0>\n";
    s += "  <GND * 1 280 250 0 0 0 0>\n";
    s += QStringLiteral("  <SUBST SubstTC1 1 410 220 -30 24 0 0 \"%1\" 1 \"%2 "
                        "mm\" 1 \"%3 um\" 1 \"%4\" 1 \"%5\" 1 \"%6\" 1>\n")
             .arg(l->getProperty("Er"))
             .arg(l->getProperty("H", UNIT_LENGTH, LENGTH_MM))
             .arg(l->getProperty("T", UNIT_LENGTH, LENGTH_UM))
    ...
    s += "\"51\" 1 \"no\" 0 \"1\" 0 \"2\" 0>\n";
    s += QStringLiteral("  <MCOUPLED MSTC1 1 190 110 -26 37 0 0 \"SubstTC1\" 1 "
                        "\"%1 mm\" 1 \"%2 mm\" 1 \"%3 mm\" 1 \"Kirschning\" 0 "
                        "\"Kirschning\" 0 \"26.85\" 0>\n")
             .arg(l->getProperty("W", UNIT_LENGTH, LENGTH_MM))
             .arg(l->getProperty("L", UNIT_LENGTH, LENGTH_MM))
  ...
  // create coaxial line schematic
    ...
    s += "\"51\" 1 \"no\" 0 \"1\" 0 \"2\" 0>\n";
    s += QStringLiteral(
             "  <COAX CXTC1 1 180 100 -26 15 0 0 \"%1\" 1 \"%2\" 0 \"%3\" 0 "
             "\"%4 mm\" 1 \"%5 mm\" 1  \"%6 mm\" 1  \"%7\" 0 \"26.85\" 0>\n")
             .arg(l->getProperty("Er"))
  ...
  // create coplanar schematic
    ...
    s += "\"51\" 1 \"no\" 0 \"1\" 0 \"2\" 0>\n";
    s +=
        QStringLiteral("  <CLIN CLTC1 1 180 100 -26 25 0 0 \"SubstTC1\" 1 \"%1 "
                       "mm\" 1 \"%2 mm\" 1 \"%3 mm\" 1 \"Air\" 1 \"yes\" 0>\n")
            .arg(l->getProperty("W", UNIT_LENGTH, LENGTH_MM))
            .arg(l->getProperty("S", UNIT_LENGTH, LENGTH_MM))
            .arg(l->getProperty("L", UNIT_LENGTH, LENGTH_MM));
    s += "  <Eqn EqnTC1 1 240 260 -23 12 0 0 \"A=twoport(S,'S','A')\" 1 "
  ...
  // create coplanar schematic
    ...
    s += "\"51\" 1 \"no\" 0 \"1\" 0 \"2\" 0>\n";
    s += QStringLiteral(
             "  <CLIN CLTC1 1 180 100 -26 25 0 0 \"SubstTC1\" 1 \"%1 mm\" 1 "
             "\"%2 mm\" 1 \"%3 mm\" 1 \"Metal\" 1 \"yes\" 0>\n")
             .arg(l->getProperty("W", UNIT_LENGTH, LENGTH_MM))
             .arg(l->getProperty("S", UNIT_LENGTH, LENGTH_MM))
             .arg(l->getProperty("L", UNIT_LENGTH, LENGTH_MM));
    s += "  <Eqn EqnTC1 1 240 260 -23 12 0 0 \"A=twoport(S,'S','A')\" 1 "
  ...
  // rectangular waveguide schematic
    ...
    s += "\"51\" 1 \"no\" 0 \"1\" 0 \"2\" 0>\n";
    s += QStringLiteral(
             "  <RECTLINE RLTC1 1 180 100 -26 25 0 0 \"%1 mm\" 1 \"%2 mm\" 1 "
             "\"%3 mm\" 1 \"%4\" 0 \"%5\" 0 \"%6\" 0 \"%7\" 0 \"26.85\" 0>\n")
