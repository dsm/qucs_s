...
void andor4x3::createSymbol() {
  ...
  Lines.append(new qucs::Line(-30, 20, 0, 20, QPen(Qt::darkBlue, 2)));
  Lines.append(new qucs::Line(-30, 60, 0, 60, QPen(Qt::darkBlue, 2)));
  Lines.append(new qucs::Line(0, -60, 0, 100, QPen(Qt::darkBlue, 2)));
  ...
  Lines.append(new qucs::Line(-50, -10, -30, -10, QPen(Qt::darkBlue, 2))); // A21
  Lines.append(new qucs::Line(-50, 0, -30, 0, QPen(Qt::darkBlue, 2)));   // A22
  Lines.append(new qucs::Line(-50, 10, -30, 10, QPen(Qt::darkBlue, 2))); // A23

  Lines.append(new qucs::Line(-50, 30, -30, 30, QPen(Qt::darkBlue, 2))); // A31
  Lines.append(new qucs::Line(-50, 40, -30, 40, QPen(Qt::darkBlue, 2))); // A32
  Lines.append(new qucs::Line(-50, 50, -30, 50, QPen(Qt::darkBlue, 2))); // A33

  Lines.append(new qucs::Line(-50, 70, -30, 70, QPen(Qt::darkBlue, 2))); // A41
  Lines.append(new qucs::Line(-50, 80, -30, 80, QPen(Qt::darkBlue, 2))); // A42
  Lines.append(new qucs::Line(-50, 90, -30, 90, QPen(Qt::darkBlue, 2))); // A43

  Lines.append(new qucs::Line(30, 20, 50, 20, QPen(Qt::darkBlue, 2))); // Y
...
QString andor4x3::vhdlCode(int) {
  ...
  s = "\n  " + Name + ":process (" + a11 + ", " + a12 + ", " + a13 + ", " +
      ...
      ", " + a41 + ", " + a42 + ", " + a43 + ")\n" + "  begin\n    " + y +
      " <= " + "(" + a11 + " and " + a12 + " and " + a13 + ") or " + "(" + a21 +
      " and " + a22 + " and " + a23 + ") or\n" + "                 (" + a31 +
      " and " + a32 + " and " + a33 + ") or " + "(" + a41 + " and " + a42 +
      " and " + a43 + ")" + td + "  end process;\n";
  return s;
}
...
QString andor4x3::verilogCode(int) {
  ...
  l = "\n  // " + Name + " 4x3 andor\n" + "  assign  " + y + " = " + v + ";\n" +
      "  reg     " + v + " = 0;\n" + "  always @ (" + a11 + " or " + a12 +
      " or " + a13 + " or " + a21 + " or " + a22 + " or " + a23 + " or " + a31 +
      " or " + a32 + " or " + a33 + " or " + a41 + " or " + a42 + " or " + a43 +
      ")\n  " + "  " + v + " <=" + td + " (" + a11 + " && " + a12 + " && " +
      a13 + ")" + " || " + "(" + a21 + " && " + a22 + " && " + a23 + ")" +
      " ||\n" + "                         (" + a31 + " && " + a32 + " && " +
      a33 + ")" + " || " + "(" + a41 + " && " + a42 + " && " + a43 + ");\n ";
