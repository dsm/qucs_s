...
vTRRANDOM::vTRRANDOM() {
  ...
  Lines.append(new qucs::Line(
      -12, 1, 1, -12, QPen(Qt::darkBlue, 3, Qt::SolidLine, Qt::FlatCap)));
  Lines.append(new qucs::Line(
      -10, 6, 6, -10, QPen(Qt::darkBlue, 3, Qt::SolidLine, Qt::FlatCap)));
  Lines.append(new qucs::Line(
      -7, 10, 10, -7, QPen(Qt::darkBlue, 3, Qt::SolidLine, Qt::FlatCap)));
  Lines.append(new qucs::Line(
      -2, 12, 12, -2, QPen(Qt::darkBlue, 3, Qt::SolidLine, Qt::FlatCap)));
  // plus sign
  ...
  Props.append(new Property(
      "Ts", "1m", true, QObject::tr("Duration of each random voltage value")));
  Props.append(
      new Property("Td", "0", true,
                   QObject::tr("Time delay before random voltages output ( for "
                               "time < Td  Vout  =  0 V)")));
  Props.append(
      new Property("Param1", "1", true,
                   QObject::tr("Changes with  different values of Type.")));
  Props.append(
      new Property("Param2", "0", true,
                   QObject::tr("Changes with different values of Type")));
...
QString vTRRANDOM::spice_netlist(
