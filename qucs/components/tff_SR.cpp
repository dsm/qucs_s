...
void tff_SR::createSymbol() {
  ...
  Polylines.append(new qucs::Polyline(
      std::vector<QPointF>{{-30, 10}, {-20, 20}, {-30, 30}},
  ...
  Texts.append(new Text(-25, -28, "T", Qt::darkBlue, 12.0));
...
QString tff_SR::spice_netlist(
  ...
  s += " " + tmp_model + "\n";
  s += QStringLiteral(".model %1 d_tff(clk_delay=%2 set_delay=%2 "
