...
iProbe::iProbe() {
  ...
  Lines.append(new qucs::Line(
      -4, -4, 4, 0, QPen(Qt::darkBlue, 2, Qt::SolidLine, Qt::FlatCap)));
  Lines.append(new qucs::Line(
      4, 0, -4, 4, QPen(Qt::darkBlue, 2, Qt::SolidLine, Qt::FlatCap)));
  ...
  // gauge
  Arcs.append(
      new qucs::Arc(-20, -23, 39, 39, 16 * 50, 16 * 80, QPen(Qt::darkBlue, 2)));
