...
JK_FlipFlop::JK_FlipFlop() {
  ...
  Polylines.append(new qucs::Polyline(
      std::vector<QPointF>{{-20, 4}, {-12, 0}, {-20, -4}},
...
QString JK_FlipFlop::vhdlCode(int NumPorts) {
  ...
  s = "  " + Name + " : process (" + Ports.at(5)->Connection->Name + ", " +
      Ports.at(6)->Connection->Name + ", " + Ports.at(4)->Connection->Name +
      ")\n  begin\n    if (" + Ports.at(6)->Connection->Name + "='1') then  " +
      ...
      Ports.at(2)->Connection->Name + " <= (" + Ports.at(0)->Connection->Name +
      " and not " + Ports.at(2)->Connection->Name + ") or (not " +
      Ports.at(1)->Connection->Name + " and " + Ports.at(2)->Connection->Name +
      ")" + s + "    end if;\n  end process;\n  " +
