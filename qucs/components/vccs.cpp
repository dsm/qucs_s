...
VCCS::VCCS() {
  ...
  // thin arrow
  Lines.append(new qucs::Line(
      -12, -18, -12, 18, QPen(Qt::darkBlue, 1, Qt::SolidLine, Qt::FlatCap)));
  Polylines.append(new qucs::Polyline(
      std::vector<QPointF>{{-17, 9}, {-12, 18}, {-7, 9}},
      QPen(Qt::darkBlue, 1, Qt::SolidLine, Qt::SquareCap, Qt::MiterJoin)));
  ...
  Props.append(
      new Property("G", "1 S", true, QObject::tr("forward transconductance")));
  Props.append(
      new Property("T", "0", false, QObject::tr("delay time (Qucsator only)")));
}
