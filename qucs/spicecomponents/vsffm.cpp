...
vSffm::vSffm() {
  ...
  Props.append(new Property("Vo", "0 V", true, QObject::tr("offset volage")));
  Props.append(
      new Property("Va", "1 V", true, QObject::tr("carrier amplitude")));
  Props.append(
      new Property("Fc", "1k", true, QObject::tr("carrier signal frequency")));
  Props.append(
