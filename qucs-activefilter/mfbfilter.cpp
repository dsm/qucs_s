...
MFBfilter::MFBfilter(Filter::FilterFunc ffunc_, Filter::FType type_,
                     FilterParam par)
...
void MFBfilter::createLowPassSchematic(QString& s) {
  ...
  s += ">\n";
  s += "<Components>\n";
  s += QStringLiteral("<.AC AC1 1 300 440 0 61 0 0 \"lin\" 1 \"1 Hz\" 1 \"%1 "
                      "kHz\" 1 \"501\" 1 \"no\" 0>\n")
           .arg((10.0 * Fc) / 1000.0);
  s += "<.DC DC1 1 60 440 0 61 0 0 \"26.85\" 0 \"0.001\" 0 \"1 pA\" 0 \"1 uV\" "
       "0 \"no\" 0 \"150\" 0 \"no\" 0 \"none\" 0 \"CroutLU\" 0>\n";
  s += "<Eqn Eqn1 1 610 450 -30 14 0 0 \"K=dB(out.v/in.v)\" 1 \"yes\" 0>\n";
  s += QStringLiteral("<Vac V1 1 %1 330 18 -26 0 1 \"1 V\" 1 \"1 kHz\" 0 \"0\" "
                      "0 \"0\" 0>\n")
           .arg(70 + dx);
  ...
  for (int i = 1; i <= N2ord; i++) {
    ...
    s += QStringLiteral(
             "<OpAmp OP%1 1 %2 270 -26 -70 1 0 \"1e6\" 1 \"15 V\" 0>\n")
             .arg(1 + (i - 1) * Nop1)
             .arg(390 + dx);
    s += QStringLiteral(
             "<C C%1 1 %2 350 17 -26 0 1 \"%3%4\" 1 \"\" 0 \"neutral\" 0>\n")
             .arg(2 + (i - 1) * Nc1)
             .arg(200 + dx)
             .arg(C2, 0, 'f', 3)
             .arg(suffix2);
    s += QStringLiteral(
             "<C C%1 1 %2 180 17 -26 0 1 \"%3%4\" 1 \"\" 0 \"neutral\" 0>\n")
             .arg(1 + (i - 1) * Nc1)
             .arg(320 + dx)
             .arg(C1, 0, 'f', 3)
             .arg(suffix1);
    s += QStringLiteral("<R R%1 1 %2 180 15 -26 0 1 \"%3k\" 1 \"26.85\" 0 "
                        "\"0.0\" 0 \"0.0\" 0 \"26.85\" 0 \"european\" 0>\n")
             .arg(1 + (i - 1) * Nr1)
             .arg(200 + dx)
             .arg(stage.R1, 0, 'f', 3);
    s += QStringLiteral("<R R%1 1 %2 250 -26 15 0 0 \"%3k\" 1 \"26.85\" 0 "
                        "\"0.0\" 0 \"0.0\" 0 \"26.85\" 0 \"european\" 0>\n")
             .arg(2 + (i - 1) * Nr1)
             .arg(150 + dx)
             .arg(stage.R2, 0, 'f', 3);
...
void MFBfilter::createHighPassSchematic(QString& s) {
  ...
  for (int i = 1; i <= N2ord; i++) {
    ...
    s += QStringLiteral(
             ...
             .arg(1 + (i - 1) * Nop1)
             .arg(390 + dx);
    s += QStringLiteral("<R R%1 1 %2 350 17 -26 0 1 \"%3k\" 1 \"26.85\" 0 "
                        "\"0.0\" 0 \"0.0\" 0 \"26.85\" 0 \"european\" 0>\n")
             .arg(1 + (i - 1) * Nr1)
             .arg(200 + dx)
             .arg(stage.R1, 0, 'f', 3);
    s += QStringLiteral("<R R%1 1 %2 180 17 -26 0 1 \"%3k\" 1 \"26.85\" 0 "
                        "\"0.0\" 0 \"0.0\" 0 \"26.85\" 0 \"european\" 0>\n")
             .arg(2 + (i - 1) * Nr1)
             .arg(320 + dx)
             .arg(stage.R2, 0, 'f', 3);
    s += QStringLiteral(
             "<C C%1 1 %2 180 15 -26 0 1 \"%3%4\" 1 \"\" 0 \"neutral\" 0>\n")
             .arg(1 + (i - 1) * Nc1)
             .arg(200 + dx)
             .arg(C1, 0, 'f', 3)
             .arg(suffix1);
    s += QStringLiteral(
             "<C C%1 1 %2 250 -26 15 0 0 \"%3%4\" 1 \"\" 0 \"neutral\" 0>\n")
             .arg(2 + (i - 1) * Nc1)
             .arg(150 + dx)
             .arg(C2, 0, 'f', 3)
             .arg(suffix2);
