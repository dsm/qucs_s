...
static const double one_over_pi =
    0.3183098861837906715377675267450287;                       /* 1/pi     */
...
public:
  ...
  // Component wrappers
  static QString getLineString(bool isMicrostrip, double width_or_impedance,
                               double l, int x, int y, int rotate = 0);
  static QString getTeeString(int x, int y, double width1, double width2,
                              double width3);
