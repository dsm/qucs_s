...
Amplifier::Amplifier() {
  ...
  Lines.append(new qucs::Line(16, 0, 30, 0, QPen(Qt::darkBlue, 2)));
  ...
  Props.append(new Property("G", "10", true, QObject::tr("voltage gain")));
  ...
  Props.append(new Property("NF", "0 dB", false, QObject::tr("noise figure")));
}
