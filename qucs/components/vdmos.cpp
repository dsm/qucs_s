...
VDMOS::VDMOS() {
  ...
  Props.append(
      new Property("Mul", "1", true, QObject::tr("Device multiplier")));
  ...
  Props.append(
      new Property("Phi", "0.6", false, QObject::tr("Surface potential (V)")));
  ...
  Props.append(
      new Property("Mtriode", "1.0", false,
                   QObject::tr("Conductance multiplier in triode region")));
  Props.append(
      new Property("Subshift", "0.0", false,
                   QObject::tr("shift along gate voltage axis in the dual "
                               "parameter subthreshold model (V)")));
  Props.append(new Property(
      "Ksubthres", "0.1", false,
  ...
  Props.append(
      new Property("Tt", "0.0", false, QObject::tr("Body diode transit time")));
  Props.append(new Property(
      "Eg", "1.11", false,
      QObject::tr(
  ...
  Props.append(
      new Property("Fc", "0.5", false,
                   QObject::tr("Body diode coefficient for forward-bias "
  ...
  Props.append(
      new Property("TKSUBTHRES1", "0.0", false,
                   QObject::tr("Linear temperature coefficient of ksubthres")));
  Props.append(new Property(
      "TKSUBTHRES2", "0.0", false,
  ...
  Props.append(
      new Property("Cthj", "10e-6", false, QObject::tr("Thermal capacitance")));
  Props.append(new Property(
      "Rthca", "1000", false,
