...
S4Q_Ieqndef::S4Q_Ieqndef() {
  Description =
      QObject::tr("SPICE B (I type):\nMultiple line ngspice or Xyce B "
  ...
  Lines.append(new qucs::Line(
      -8, 0, 8, 0, QPen(Qt::darkRed, 3, Qt::SolidLine, Qt::FlatCap)));
...
QString S4Q_Ieqndef::spice_netlist(
...
QString S4Q_Ieqndef::va_code() {
  ...
  if (Props.at(0)->Name == "I") {
    ...
    Src = vacompat::normalize_voltage(
        plus, minus); // Voltage contribution is reserved for future
  }
