...
potentiometer::potentiometer() {
  ...
  Props.append(new Property(
      "LEVEL", "1", false, QObject::tr("device type selector") + " [1, 2, 3]"));
...
void potentiometer::createSymbol() {
  ...
  Lines.append(new qucs::Line(
      -40, 0, -25, 0, QPen(Qt::darkBlue, 2, Qt::SolidLine, Qt::FlatCap)));
  Lines.append(new qucs::Line(
      -25, 0, -20, -5, QPen(Qt::darkBlue, 2, Qt::SolidLine, Qt::RoundCap)));
  ...
  Lines.append(new qucs::Line(
      20, -5, 25, 0, QPen(Qt::darkBlue, 2, Qt::SolidLine, Qt::RoundCap)));
  Lines.append(new qucs::Line(
      25, 0, 40, 0, QPen(Qt::darkBlue, 2, Qt::SolidLine, Qt::FlatCap)));
...
QString potentiometer::spice_netlist(
  ...
  QString max_rot =
      spicecompat::normalize_value(getProperty("Max_Rotation")->Value);
  QString pin1 =
