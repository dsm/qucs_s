...
SpiceGeneric::SpiceGeneric() {
  ...
  Props.append(
      new Property("Letter", "Z", true, QObject::tr("SPICE device letter")));
  Props.append(
      new Property("Model", "", false,
                   QObject::tr(".MODEL definition reference (optional)")));
  Props.append(new Property("Params", "", false,
                            QObject::tr("Parameter string (optional)")));
...
QString SpiceGeneric::spice_netlist(
