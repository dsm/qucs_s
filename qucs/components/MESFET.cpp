...
MESFET::MESFET() {
  ...
  Props.append(
      new Property("LEVEL", "1", false, QObject::tr("model selector")));
  ...
  Props.append(new Property(
      ...
      QObject::tr(
          ...
          " (" + QObject::tr("V") + ")"));
  Props.append(
      new Property("Vdelta1", "0.3", false,
                   QObject::tr("capacitance saturation transition voltage") +
                       " (" + QObject::tr("V") + ")"));
  Props.append(
      new Property("Vdelta2", "0.2", false,
  ...
  Props.append(new Property("Is", "1e-14", false,
                            QObject::tr("diode saturation current") + " (" +
                                QObject::tr("I") + ")"));
  Props.append(
      new Property("N", "1", false, QObject::tr("diode emission coefficient")));
  ...
  Props.append(new Property("Rin", "1e-3", false,
                            QObject::tr("channel resistance") + " (" +
                                QObject::tr("Ohm") + ")"));
  Props.append(new Property("Area", "1", false, QObject::tr("area factor")));
  Props.append(
      new Property("Eg", "1.11", false,
                   QObject::tr("energy gap") + " (" + QObject::tr("eV") + ")"));
  Props.append(
      new Property("M", "0.5", false, QObject::tr("grading coefficient")));
  Props.append(
      new Property("Cgd", "0.2e-12", false,
                   QObject::tr("zero bias gate-drain junction capacitance") +
                       " (" + QObject::tr("F") + ")"));
  Props.append(
      new Property("Cgs", "1e-12", false,
                   QObject::tr("zero bias gate-source junction capacitance") +
                       " (" + QObject::tr("F") + ")"));
  Props.append(
      new Property("Cds", "1e-12", false,
  ...
  Props.append(
      new Property("Kf", "0", false, QObject::tr("flicker noise coefficient")));
