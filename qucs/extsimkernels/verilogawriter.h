...
QString normalize_voltage(QString& plus, QString& minus,
                          bool left_side = false); // Exclude gnd nodes from
QString normalize_current(QString& plus, QString& minus,
                          bool left_side = false); // currents and voltages
} // namespace vacompat
