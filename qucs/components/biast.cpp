...
BiasT::BiasT() {
  ...
  Arcs.append(
      new qucs::Arc(-3, 2, 6, 6, 16 * 270, 16 * 180, QPen(Qt::darkBlue, 2)));
  Arcs.append(
      new qucs::Arc(-3, 8, 6, 6, 16 * 270, 16 * 180, QPen(Qt::darkBlue, 2)));
  Arcs.append(
      new qucs::Arc(-3, 14, 6, 6, 16 * 270, 16 * 180, QPen(Qt::darkBlue, 2)));
