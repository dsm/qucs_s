...
AM_Modulator::AM_Modulator() {
  ...
  // wave
  Arcs.append(new qucs::Arc(-7, -4, 7, 7, 0, 16 * 180,
                            QPen(Qt::darkBlue, 2, Qt::SolidLine, Qt::FlatCap)));
  Arcs.append(new qucs::Arc(0, -4, 7, 7, 16 * 180, 16 * 180,
                            QPen(Qt::darkBlue, 2, Qt::SolidLine, Qt::FlatCap)));
  // pins
  ...
  Lines.append(new qucs::Line(-12, 0, -17, -5, QPen(Qt::darkBlue, 2)));
  Texts.append(
      new Text(-30, -22, QObject::tr("AM"), Qt::black, 10.0, 1.0, 0.0));
  ...
  Props.append(
      new Property("U", "1 V", true, QObject::tr("peak voltage in Volts")));
  Props.append(
      new Property("f", "1 GHz", false, QObject::tr("frequency in Hertz")));
  Props.append(new Property("Phase", "0", false,
                            QObject::tr("initial phase in degrees")));
  Props.append(
      new Property("m", "1.0", false, QObject::tr("modulation level")));
}
