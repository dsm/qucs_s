...
Hybrid::Hybrid() {
  ...
  Arcs.append(new qucs::Arc(-28, -28, 28, 28, 16 * 270, 16 * 90,
                            QPen(Qt::darkBlue, 1)));
  Arcs.append(
      new qucs::Arc(0, -28, 28, 28, 16 * 180, 16 * 90, QPen(Qt::darkBlue, 1)));
  Arcs.append(new qucs::Arc(-28, 0, 28, 28, 0, 16 * 90, QPen(Qt::darkBlue, 1)));
  Arcs.append(
      new qucs::Arc(0, 0, 28, 28, 16 * 90, 16 * 90, QPen(Qt::darkBlue, 1)));

  Arcs.append(
      new qucs::Arc(-11, -11, 4, 6, 0, 16 * 360, QPen(Qt::darkBlue, 1)));
  ...
  Props.append(
      new Property("phi", "90", true, QObject::tr("phase shift in degree")));
