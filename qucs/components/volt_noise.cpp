...
Volt_noise::Volt_noise() {
  ...
  Lines.append(new qucs::Line(
      -10, 6, 6, -10, QPen(Qt::darkBlue, 2, Qt::SolidLine, Qt::FlatCap)));
  Lines.append(new qucs::Line(
      -7, 10, 10, -7, QPen(Qt::darkBlue, 2, Qt::SolidLine, Qt::FlatCap)));
  Lines.append(new qucs::Line(
      -2, 12, 12, -2, QPen(Qt::darkBlue, 2, Qt::SolidLine, Qt::FlatCap)));
