...
iTRNOISE::iTRNOISE() {
  ...
  Lines.append(new qucs::Line(
      -12, 1, 1, -12, QPen(Qt::darkGray, 3, Qt::SolidLine, Qt::FlatCap)));
  Lines.append(new qucs::Line(
      -10, 6, 6, -10, QPen(Qt::darkGray, 3, Qt::SolidLine, Qt::FlatCap)));
  Lines.append(new qucs::Line(
      -7, 10, 10, -7, QPen(Qt::darkGray, 3, Qt::SolidLine, Qt::FlatCap)));
  Lines.append(new qucs::Line(
      -2, 12, 12, -2, QPen(Qt::darkGray, 3, Qt::SolidLine, Qt::FlatCap)));
  // arrow
  Lines.append(new qucs::Line(-7, 0, 6, 0,
                              QPen(Qt::blue, 3, Qt::SolidLine, Qt::FlatCap)));
  Polylines.append(new qucs::Polyline(
      std::vector<QPointF>{{0, -4}, {6, 0}, {0, 4}},
      QPen(Qt::blue, 3, Qt::SolidLine, Qt::SquareCap, Qt::MiterJoin)));
  ...
  Props.append(new Property("Nt", "0.5n", true, QObject::tr("Time step")));
  Props.append(new Property("Nalpha", "1.1", true,
                            QObject::tr("1/f exponent (0  < alpha < 2)")));
  Props.append(
      new Property("Namp", "12p", true, QObject::tr("Amplitude (1/f)")));
  Props.append(
      new Property("Rtsam", "0", true, QObject::tr("Amplitude (1/f)")));
  Props.append(
      new Property("Rtscapt", "0", true, QObject::tr("Trap capture time")));
  Props.append(
      new Property("Rtsemt", "0", true, QObject::tr("Trap emission time")));
...
QString iTRNOISE::spice_netlist(
