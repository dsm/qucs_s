...
SpiceSENS::SpiceSENS() {
  ...
  Props.append(
      new Property("Output", "v(out)", true, QObject::tr("Output variable")));
  Props.append(
      new Property("Param", "R1", true, QObject::tr("parameter to sweep")));
  Props.append(
      new Property("Start", "5", true, QObject::tr("start value for sweep")));
  Props.append(
      new Property("Stop", "50", true, QObject::tr("stop value for sweep")));
  Props.append(new Property("Step", "1", true, QObject::tr("Simulation step")));
}
...
QString SpiceSENS::spice_netlist(
