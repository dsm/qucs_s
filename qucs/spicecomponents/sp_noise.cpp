...
SpiceNoise::SpiceNoise() {
  ...
  Props.append(
      new Property("Output", "v(node1)", true,
...
QString SpiceNoise::spice_netlist(
  ...
  QString swp = spicecompat::convert_sweep_type(
      Props.at(0)->Value); // Sweep mode (lin,dec,etc.)
