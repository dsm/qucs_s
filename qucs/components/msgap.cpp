...
MSgap::MSgap() {
  ...
  Lines.append(new qucs::Line(10, -8, 23, -8, QPen(Qt::darkBlue, 2)));
  Lines.append(new qucs::Line(-23, 8, -10, 8, QPen(Qt::darkBlue, 2)));
  Lines.append(new qucs::Line(0, 8, 13, 8, QPen(Qt::darkBlue, 2)));
  ...
  Lines.append(new qucs::Line(10, -8, 0, 8, QPen(Qt::darkBlue, 2)));
  ...
  Props.append(
      new Property("W1", "1 mm", true, QObject::tr("width of the line 1")));
  Props.append(
      new Property("W2", "1 mm", true, QObject::tr("width of the line 2")));
  Props.append(new Property(
      "S", "1 mm", true, QObject::tr("spacing between the microstrip ends")));
