...
LTL_SPICE::LTL_SPICE() {
  ...
  Property::Builder b;
  b.simulator(static_cast<spicecompat::Simulator>(spicecompat::simSpice ^
                                                  spicecompat::simXyce));

  Props.append(
      b.property("Z0", "50 ", QObject::tr("Characteristic impedance")));
  Props.append(b.property("Td", "0.25n ", QObject::tr("Transmission delay")));
  Props.append(b.property("F", "1e9", QObject::tr("Frequency")));
  Props.append(b.property("Nl", "0.25",
                          QObject::tr("Normalised length at given frequency")));
...
QString LTL_SPICE::spice_netlist(
