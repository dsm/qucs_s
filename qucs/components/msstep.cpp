...
MSstep::MSstep() {
  ...
  Lines.append(new qucs::Line(-18, -12, 0, -12, QPen(Qt::darkBlue, 2)));
  Lines.append(new qucs::Line(-18, 12, 0, 12, QPen(Qt::darkBlue, 2)));
  Lines.append(new qucs::Line(-18, -12, -18, 12, QPen(Qt::darkBlue, 2)));
  Lines.append(new qucs::Line(0, -7, 18, -7, QPen(Qt::darkBlue, 2)));
  Lines.append(new qucs::Line(0, 7, 18, 7, QPen(Qt::darkBlue, 2)));
  Lines.append(new qucs::Line(18, -7, 18, 7, QPen(Qt::darkBlue, 2)));
  Lines.append(new qucs::Line(0, -12, 0, -7, QPen(Qt::darkBlue, 2)));
  Lines.append(new qucs::Line(0, 7, 0, 12, QPen(Qt::darkBlue, 2)));
  ...
  Props.append(
      new Property("W1", "2 mm", true, QObject::tr("width 1 of the line")));
  Props.append(
      new Property("W2", "1 mm", true, QObject::tr("width 2 of the line")));
