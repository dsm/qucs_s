...
JA_core::JA_core() {
  ...
  Props.append(new Property("A", "26.0", true,
                            QObject::tr("Domains wall density (A/m)")));
  Props.append(
      new Property("K", "27.0", true, QObject::tr("Domains pinning (A/m)")));
  Props.append(new Property("C", "0.05", true,
                            QObject::tr("Magnetization reversibility")));
  Props.append(new Property("Ms", "395e3", true,
                            QObject::tr("Saturation magnetization (A/m)")));
  Props.append(
      new Property("alpha", "1e-4", true, QObject::tr("Interdomain coupling")));
  Props.append(new Property("PATH", "1.0", true,
                            QObject::tr("Magnetic path length (m)")));
  Props.append(new Property("AREA", "1.0", true,
                            QObject::tr("Core cross section area (m^2)")));
  Props.append(
      new Property("GAP", "0.0", true, QObject::tr("Air gap length (m)")));
  Props.append(
      new Property("CoreType", "generic", true, "[generic,ring,E-type]"));
