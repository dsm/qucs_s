...
BondWire::BondWire() {
  ...
  Arcs.append(new qucs::Arc(-11, -10, 22, 26, 16 * 30, 16 * 120,
                            QPen(Qt::darkBlue, 1)));
  Arcs.append(new qucs::Arc(-19, -13, 10, 13, 16 * 205, 16 * 130,
                            QPen(Qt::darkBlue, 1)));
  Arcs.append(
      new qucs::Arc(9, -13, 10, 13, 16 * 205, 16 * 130, QPen(Qt::darkBlue, 1)));
  ...
  Props.append(
      new Property("L", "3 mm", true, QObject::tr("length of the wire")));
  Props.append(
      new Property("D", "50 um", true, QObject::tr("diameter of the wire")));
  ...
  Props.append(new Property("Model", "FREESPACE", false,
                            QObject::tr("bond wire model") +
                                " [FREESPACE, MIRROR, DESCHARLES]"));
