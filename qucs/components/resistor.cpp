...
Resistor::Resistor(bool european) {
  ...
  Props.append(
      b.property("R", "1 kOhm", QObject::tr("ohmic resistance in Ohms")));
  ...
  Props.append(b.property(
      "Tnom", "26.85",
      QObject::tr(
          "temperature at which parameters were extracted (Qucsator only)")));
...
QString Resistor::spice_netlist(
  ...
  s += QStringLiteral(" %1").arg(
      spicecompat::normalize_value(Props.at(0)->Value));
...
QString Resistor::va_code() {
  ...
  s += QStringLiteral("%1 <+ white_noise( 4.0*`P_K*( %2 + 273.15) / ( %3 ), "
                      "\"thermal\" );\n")
           .arg(Ipm)
           .arg(valTemp)
           .arg(val);
...
void Resistor::createSymbol() {
  if (Props.back()->Value != "US") {
    ...
    Lines.append(new qucs::Line(
        -18, 0, -15, -7, QPen(Qt::darkBlue, 2, Qt::SolidLine, Qt::RoundCap)));
    Lines.append(new qucs::Line(
        -15, -7, -9, 7, QPen(Qt::darkBlue, 2, Qt::SolidLine, Qt::RoundCap)));
    Lines.append(new qucs::Line(
        -9, 7, -3, -7, QPen(Qt::darkBlue, 2, Qt::SolidLine, Qt::RoundCap)));
    Lines.append(new qucs::Line(
        -3, -7, 3, 7, QPen(Qt::darkBlue, 2, Qt::SolidLine, Qt::RoundCap)));
    Lines.append(new qucs::Line(
        3, 7, 9, -7, QPen(Qt::darkBlue, 2, Qt::SolidLine, Qt::RoundCap)));
    Lines.append(new qucs::Line(
        9, -7, 15, 7, QPen(Qt::darkBlue, 2, Qt::SolidLine, Qt::RoundCap)));
    Lines.append(new qucs::Line(
        15, 7, 18, 0, QPen(Qt::darkBlue, 2, Qt::SolidLine, Qt::RoundCap)));
    Lines.append(new qucs::Line(18, 0, 30, 0, QPen(Qt::darkBlue, 2)));
  }
