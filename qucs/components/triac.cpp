...
Triac::Triac() {
  ...
  Lines.append(new qucs::Line(-13, 10, -9, 6, QPen(Qt::darkBlue, 2)));
  Lines.append(new qucs::Line(-30, 10, -13, 10, QPen(Qt::darkBlue, 2)));
