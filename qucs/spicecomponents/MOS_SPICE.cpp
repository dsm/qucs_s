...
MOS_SPICE::MOS_SPICE() {
  Description =
      QObject::tr("Unified (M,X,3-,4-pin) MOS:\nMultiple line ngspice or Xyce "
...
Element* MOS_SPICE::info_NM3pin(QString& Name, char*& BitmapFile,
                                bool getNewOne) {
...
Element* MOS_SPICE::info_PM3pin(QString& Name, char*& BitmapFile,
                                bool getNewOne) {
...
Element* MOS_SPICE::info_NX3pin(QString& Name, char*& BitmapFile,
                                bool getNewOne) {
...
Element* MOS_SPICE::info_PX3pin(QString& Name, char*& BitmapFile,
                                bool getNewOne) {
...
Element* MOS_SPICE::info_NX4pin(QString& Name, char*& BitmapFile,
                                bool getNewOne) {
...
Element* MOS_SPICE::info_PX4pin(QString& Name, char*& BitmapFile,
                                bool getNewOne) {
...
QString MOS_SPICE::spice_netlist(
